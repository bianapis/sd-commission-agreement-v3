...
/**
 * BQCommissionTermsExchangeOutputModel
 */
public class BQCommissionTermsExchangeOutputModel   {
  ...
  private String commissionTermsExchangeActionTaskReference = null;

  private Object commissionTermsExchangeActionTaskRecord = null;

  private String commissionTermsExchangeActionResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Commission Terms instance exchange service call 
   * @return commissionTermsExchangeActionTaskReference
  **/

  public String getCommissionTermsExchangeActionTaskReference() {
    return commissionTermsExchangeActionTaskReference;
  }

  public void setCommissionTermsExchangeActionTaskReference(String commissionTermsExchangeActionTaskReference) {
    this.commissionTermsExchangeActionTaskReference = commissionTermsExchangeActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The exchange service call consolidated processing record 
   * @return commissionTermsExchangeActionTaskRecord
  **/

  public Object getCommissionTermsExchangeActionTaskRecord() {
    return commissionTermsExchangeActionTaskRecord;
  }

  public void setCommissionTermsExchangeActionTaskRecord(Object commissionTermsExchangeActionTaskRecord) {
    this.commissionTermsExchangeActionTaskRecord = commissionTermsExchangeActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Details of the exchange action service response 
   * @return commissionTermsExchangeActionResponse
  **/

  public String getCommissionTermsExchangeActionResponse() {
    return commissionTermsExchangeActionResponse;
  }

  public void setCommissionTermsExchangeActionResponse(String commissionTermsExchangeActionResponse) {
    this.commissionTermsExchangeActionResponse = commissionTermsExchangeActionResponse;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Commission Terms instance (e.g. accepted, rejected, verified) 
