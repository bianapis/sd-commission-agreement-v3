...
/**
 * BQCommissionTermsRequestOutputModel
 */
public class BQCommissionTermsRequestOutputModel   {
  ...
  private String commissionTermsRequestActionTaskReference = null;

  private Object commissionTermsRequestActionTaskRecord = null;

  private String commissionTermsRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Commission Terms instance request service call 
   * @return commissionTermsRequestActionTaskReference
  **/

  public String getCommissionTermsRequestActionTaskReference() {
    return commissionTermsRequestActionTaskReference;
  }

  public void setCommissionTermsRequestActionTaskReference(String commissionTermsRequestActionTaskReference) {
    this.commissionTermsRequestActionTaskReference = commissionTermsRequestActionTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Commission Terms service request record 
   * @return commissionTermsRequestRecordReference
  **/

  public String getCommissionTermsRequestRecordReference() {
    return commissionTermsRequestRecordReference;
  }

  public void setCommissionTermsRequestRecordReference(String commissionTermsRequestRecordReference) {
    this.commissionTermsRequestRecordReference = commissionTermsRequestRecordReference;
  }
